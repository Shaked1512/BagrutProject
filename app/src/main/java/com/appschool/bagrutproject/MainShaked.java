...
public class MainShaked extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        products.add("ACTION_POWER_CONNECTED");products.add("ACTION_POWER_DISCONNECTED");
        products.add("ACTION_SHUTDOWN");products.add("AIRPLANE_MODE");
        products.add("BATTERY_CHANGED");products.add("BATTERY_LOW");
        products.add("BATTERY_OKAY"); products.add("USB_CONNECTED");
